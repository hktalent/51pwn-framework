...
# version 1.3.3
---------------
fix #37 frwk_51pwn\lib\core\revision.py
...
# version 1.4.2
---------------
* 修复console模式下一处bug，https://github.com/51pwn-framework/frwk_51pwn/pull/61
...
* bugfix 引入frwk_51pwn后再次引入requests导致的报错
