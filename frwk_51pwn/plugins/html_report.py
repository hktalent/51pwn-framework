...
from frwk_51pwn.lib.utils.markup import page
...
class HtmlExport:
    ...
    def _writer_footer(self):
        text = 'Report was automatically generated by frwk_51pwn version {0} @ {1}</br>Command line: {2}'.format(
            __version__,
    ...
    def write_html(self, results=None):
        menus = {
            ...
            'Help': 'https://github.com/51pwn-framework/frwk_51pwn/blob/master/docs/CODING.md',
            'Bug report': 'https://github.com/51pwn-framework/frwk_51pwn/issues',
        }
        self._write_header()
        self._write_navbar(name='frwk_51pwn3', menus=menus)
...
class HtmlReport(PluginBase):
    ...
    def start(self):
        ...
        filename = "frwk_51pwn_{0}.html".format(time.strftime("%Y%m%d_%H%M%S"))
