...
from frwk_51pwn.lib.core.enums import (
    CUSTOM_LOGGING, OS, OS_ARCH, SHELLCODE_CONNECTION
)
# for frwk_51pwn 2.x
from frwk_51pwn.lib.core.exception import frwk_51pwnGenericException
from frwk_51pwn.shellcodes import OSShellcodes
...
def generate_shellcode_list(listener_ip, listener_port, os_target=OS.WINDOWS, os_target_arch=OS_ARCH.X86,
    ...
    if not os.path.exists(filepath):
        raise frwk_51pwnGenericException("generate file does not exist!")
...
def gen_cert(emailAddress="s1@seebug.org",
             ...
             organizationUnitName="frwk_51pwn.org",
             serialNumber=0,
