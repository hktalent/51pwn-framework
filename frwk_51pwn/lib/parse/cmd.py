...
from frwk_51pwn.lib.core.settings import IS_WIN, CMD_PARSE_WHITELIST
...
def cmd_line_parser(argv=None):
    ...
    parser = argparse.ArgumentParser(prog='frwk_51pwn3', usage=usage)
    try:
        ...
        # Mode options
        mode = parser.add_argument_group("Mode", "frwk_51pwn running mode options")
