...
from frwk_51pwn.lib.core.clear import remove_extra_log_message
from frwk_51pwn.lib.core.common import boldify_message, check_file, get_file_items, parse_target, \
    get_public_type_members, data_to_stdout
from frwk_51pwn.lib.core.common import check_path, extract_cookies
from frwk_51pwn.lib.core.common import get_local_ip, desensitization, get_host_ip
from frwk_51pwn.lib.core.common import single_time_warn_message
from frwk_51pwn.lib.core.common import OrderedSet
from frwk_51pwn.lib.core.convert import stdout_encode
from frwk_51pwn.lib.core.data import conf, cmd_line_options
from frwk_51pwn.lib.core.data import kb
from frwk_51pwn.lib.core.data import logger
from frwk_51pwn.lib.core.data import merged_options
from frwk_51pwn.lib.core.data import paths
from frwk_51pwn.lib.core.datatype import AttribDict
from frwk_51pwn.lib.core.enums import HTTP_HEADER, CUSTOM_LOGGING, PROXY_TYPE
from frwk_51pwn.lib.core.exception import frwk_51pwnSyntaxException, frwk_51pwnSystemException, frwk_51pwnHeaderTypeException
from frwk_51pwn.lib.core.log import FORMATTER
from frwk_51pwn.lib.core.register import load_file_to_module
from frwk_51pwn.lib.core.settings import DEFAULT_USER_AGENT, DEFAULT_LISTENER_PORT, CMD_PARSE_WHITELIST
from frwk_51pwn.lib.core.statistics_comparison import StatisticsComparison
from frwk_51pwn.lib.core.update import update
from frwk_51pwn.lib.parse.cmd import DIY_OPTIONS
from frwk_51pwn.lib.parse.configfile import config_file_parser
from frwk_51pwn.lib.parse.rules import regex_rule
from frwk_51pwn.lib.request.patch import patch_all
from frwk_51pwn.modules.listener import start_listener


def _resolve_cross_references():
    import frwk_51pwn
    frwk_51pwn.lib.core.revision.stdout_encode = stdout_encode
    frwk_51pwn.lib.core.convert.single_time_warn_message = single_time_warn_message


def set_verbosity():
    """
    This function set the verbosity of frwk_51pwn output messages.
    """
...
def _set_network_timeout():
    if conf.timeout:
        ...
        if conf.timeout < 3.0:
            warn_msg = "the minimum HTTP timeout is 3 seconds, frwk_51pwn "
...
def _set_network_proxy():
    if conf.proxy:
        ...
        try:
            ...
            raise frwk_51pwnSyntaxException(err_msg)
...
def _set_pocs_modules():
    ...
    if conf.poc:
        # step1. load system packed poc from frwk_51pwn/pocs folder
...
def _cleanup_options():
    ...
    if conf.cookie:
        if isinstance(conf.cookie, str):
            ...
            raise frwk_51pwnHeaderTypeException('Does not support type for cookie')
    if conf.delay:
...
def _init_target_from_poc_dork():
    ...
    for poc_module, poc_class in kb.registered_pocs.items():
        ...
        importlib.import_module(f'frwk_51pwn.plugins.{plugin_name}')
        for _, plugin in kb.plugins.targets.items():
