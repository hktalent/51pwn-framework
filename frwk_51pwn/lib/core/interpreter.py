...
from frwk_51pwn.lib.core.common import banner, index_modules, data_to_stdout, humanize_path, module_required, \
    get_poc_name, stop_after, get_local_ip, is_ipv6_address_format, rtrim, ltrim, exec_cmd
from frwk_51pwn.lib.core.data import logger, paths, kb, conf
from frwk_51pwn.lib.core.enums import POC_CATEGORY, AUTOCOMPLETE_TYPE
from frwk_51pwn.lib.core.exception import frwk_51pwnBaseException, frwk_51pwnShellQuitException
from frwk_51pwn.lib.core.option import _set_listener, _set_http_referer, _set_http_user_agent, _set_network_proxy, \
...
from frwk_51pwn.lib.core.shell import auto_completion, readline
...
class BaseInterpreter(object):
    ...
    def get_command_handler(self, command):
        ...
        try:
            ...
            raise frwk_51pwnBaseException("frwk_51pwn3 Unknown this command, and run it on system: '{}'".format(command))
    ...
    def start(self):
        ...
        while True:
            ...
            except frwk_51pwnBaseException as warn:
                logger.warn(warn)
            except EOFError:
                logger.info("frwk_51pwn stopped")
                break
...
class frwk_51pwnInterpreter(BaseInterpreter):
    ...
    def __init__(self, module_directory=paths.POCSUITE_POCS_PATH):
        super(frwk_51pwnInterpreter, self).__init__()

        self.current_module = None
        self.raw_prompt_template = None
        self.module_prompt_template = None
        self.prompt_hostname = "frwk_51pwn3"
    ...
    def module_metadata(self):
        return getattr(self.current_module, "frwk_51pwn_module_path")
    ...
    def command_use(self, module_path, *args, **kwargs):
        ...
        try:
            ...
            self.current_module.frwk_51pwn_module_path = ltrim(
