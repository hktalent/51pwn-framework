...
from frwk_51pwn.lib.core.common import parse_target_url, desensitization
from frwk_51pwn.lib.core.data import conf
from frwk_51pwn.lib.core.data import logger
from frwk_51pwn.lib.core.enums import OUTPUT_STATUS, CUSTOM_LOGGING, ERROR_TYPE_ID, POC_CATEGORY
from frwk_51pwn.lib.core.exception import frwk_51pwnValidationException
from frwk_51pwn.lib.core.interpreter_option import OptString, OptInteger, OptIP, OptPort, OptBool
from frwk_51pwn.lib.utils import str_to_dict
# for frwk_51pwn 2.x
from frwk_51pwn.lib.core.register import register_poc as register
...
class POCBase(object):
    ...
    def get_option(self, name):
        if name not in self.options:
            raise frwk_51pwnValidationException
    ...
    def set_option(self, key, value):
        ...
        if key not in self.options:
            raise frwk_51pwnValidationException("No key " + key)
