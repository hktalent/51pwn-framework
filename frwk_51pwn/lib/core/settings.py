...
from frwk_51pwn import __version__
from frwk_51pwn.lib.core.revision import get_revision_number

VERSION = __version__
REVISION = get_revision_number()
SITE = "https://51pwn.com"
VERSION_STRING = "frwk_51pwn/%s%s" % (VERSION, "-%s" % REVISION if REVISION else "-nongit-%s" % time.strftime("%Y%m%d",
                                                                                                            time.gmtime(
                                                                                                                os.path.getctime(
                                                                                                                    __file__.replace(
                                                                                                                        '.pyc',
...
ISSUES_PAGE = "https://github.com/51pwn-framework/frwk_51pwn/issues"
GIT_REPOSITORY = "https://github.com/51pwn-framework/frwk_51pwn.git"
GIT_PAGE = "https://github.com/51pwn-framework/frwk_51pwn"
ZIPBALL_PAGE = "https://github.com/51pwn-framework/frwk_51pwn/zipball/master"

LEGAL_DISCLAIMER = "Usage of frwk_51pwn for attacking targets without prior mutual consent is illegal."
...
POCSUITE_VERSION_CHARACTER = ("from frwk_51pwn.poc import", "from frwk_51pwn.net import")
POC_IMPORTDICT = {
    ...
    "from frwk_51pwn.net import req": "from frwk_51pwn.lib.request import requests as req",
    "from frwk_51pwn.api.request import req": "from frwk_51pwn.lib.request import requests as req",
    "from frwk_51pwn.poc import": "from frwk_51pwn.lib.core.poc import",
    "from frwk_51pwn.api.poc import": "from frwk_51pwn.lib.core.poc import",
    "from frwk_51pwn.utils import register": "from frwk_51pwn.lib.core.register import register_poc as register",
    "from frwk_51pwn.lib.utils.funs import randomStr": "from frwk_51pwn.lib.utils import random_str as randomStr",
    "from frwk_51pwn.api.utils import randomStr": "from frwk_51pwn.lib.utils import random_str as randomStr",
    "from frwk_51pwn.lib.utils.funs import url2ip": "from frwk_51pwn.lib.utils import url2ip",
    "from frwk_51pwn.api.utils import url2ip": "from frwk_51pwn.lib.utils import url2ip",
    ".content": ".text",
}
