...
from frwk_51pwn.lib.utils import gen_cert
from frwk_51pwn.lib.core.common import check_port
from frwk_51pwn.lib.core.common import get_host_ip, get_host_ipv6
from frwk_51pwn.lib.core.data import logger, paths
from frwk_51pwn.lib.core.exception import frwk_51pwnSystemException


class PHTTPSingleton(type):
    '''
    HTTP server only allow one instance in frwk_51pwn
    '''
    _instance = None
...
class PHTTPServer(threading.Thread, metaclass=PHTTPSingleton):
    def __init__(self, bind_ip='0.0.0.0', bind_port=666, is_ipv6=False, use_https=False,
        ...
        if ':' in bind_ip:
            ...
            if not ipv6:
                ...
                raise frwk_51pwnSystemException
            self.host_ip = ipv6
    ...
    def start(self, daemon=True):
        # Http server can only allow start once in frwk_51pwn, avoid muti-threading start muti-times
