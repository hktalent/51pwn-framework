...
from frwk_51pwn.lib.core.common import data_to_stdout, has_poll, get_unicode, desensitization
from frwk_51pwn.lib.core.data import conf, kb, logger
from frwk_51pwn.lib.core.datatype import AttribDict
from frwk_51pwn.lib.core.enums import AUTOCOMPLETE_TYPE, OS, CUSTOM_LOGGING
...
from frwk_51pwn.lib.core.shell import auto_completion, clear_history, save_history, load_history
from frwk_51pwn.lib.core.threads import exception_handled_function
...
def handle_listener_connection():
    ...
    while True:
        ...
        if not cmd:
            ...
            raise frwk_51pwnShellQuitException
        elif cmd == "list":
            list_clients()
