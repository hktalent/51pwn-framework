...
class TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.path = os.path.join(self.root, "../frwk_51pwn_test.ini")
        self.path2 = os.path.join(self.root, "../frwk_51pwn.ini")
    ...
    def test_build_ini(self):
        ...
        try:
            ...
            # Mode options
            mode = OptionGroup(parser, "Mode", "frwk_51pwn running mode options")
